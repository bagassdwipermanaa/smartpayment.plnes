...
CREATE TABLE `unggah` (
  ...
  KEY `upl` (`id_pengguna`) USING BTREE
...
LOCK TABLES `unggah` WRITE;
/*!40000 ALTER TABLE `unggah` DISABLE KEYS */;
INSERT INTO `unggah` VALUES ('1','1','1');
/*!40000 ALTER TABLE `unggah` ENABLE KEYS */;
UNLOCK TABLES;
