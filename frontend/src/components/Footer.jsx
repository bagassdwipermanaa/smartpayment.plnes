      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-300 mb-6 leading-relaxed max-w-md">
              Platform pembayaran vendor terpercaya yang memudahkan pengelolaan
              transaksi dengan teknologi terdepan dan keamanan tingkat bank.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <svg
                  className="w-5 h-5 mr-3 mt-1 text-blue-400 flex-shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        <div className="mt-12 pt-8 border-t border-slate-800">
          <div className="flex flex-col lg:flex-row justify-between items-center">
            <div className="mb-6 lg:mb-0">
              ...
              <div className="bg-gradient-to-r from-blue-900/50 to-cyan-900/50 backdrop-blur-sm rounded-xl p-4 border border-blue-800/30">
                <div className="text-center">
                  ...
                  <div className="text-xs text-blue-300">[SMAP]</div>
                </div>
              </div>
            </div>
        ...
        <div className="mt-8 pt-8 border-t border-slate-800 text-center">
          <p className="text-slate-400 text-sm">
            © 2024 PT PLN Electricity Services. All rights reserved.
