...
DROP TABLE IF EXISTS `log_aplikasi`;
...
--
-- Dumping data for table `log_aplikasi`
--

LOCK TABLES `log_aplikasi` WRITE;
/*!40000 ALTER TABLE `log_aplikasi` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_aplikasi` ENABLE KEYS */;
UNLOCK TABLES;
